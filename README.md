...
#### Technical Details
- **Dataset**: [Starbucks App Customer Rewards Program Data](https://www.kaggle.com/datasets/blacktile/starbucks-app-customer-reward-program-data) — 17,000 customers, 306,534 events over a simulated 30-day window, 10 promotional offers (BOGO, discount, informational)
